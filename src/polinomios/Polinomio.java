...
public class Polinomio {
    ...
    public static Polinomio multiplicar2(Polinomio p1, Polinomio p2) {
        Polinomio guardap1 = new Polinomio();
        Nodo n = new Nodo();
        Nodo apuntador1 = p1.obtenerCabeza();
        Nodo apuntador2 = p2.obtenerCabeza();
        Nodo resultado = guardap1.obtenerCabeza();
        Nodo predecedor = null;

        while (apuntador1 != null) {
            while (apuntador2 != null) {
                n.coeficiente = apuntador1.coeficiente * apuntador2.coeficiente;
                n.exponente = apuntador1.exponente + apuntador2.exponente;
                guardap1.agregar(n);
                apuntador2 = apuntador2.siguiente;
            }
            apuntador1 = apuntador1.siguiente;
        ...
        while (resultado != null) {
            if (resultado.exponente == n.exponente) {
                resultado.coeficiente = resultado.coeficiente + n.coeficiente;
            } else {
                resultado = resultado.siguiente;
            }
        }

        //   Nodo apuntador3 = guardap1.cabeza;
        // while (apuntador3 != null){
        //   if ()
        // 
        return guardap1;
    }

    public static Polinomio validarDivision(Polinomio p1, Polinomio p2, Polinomio r) {
        Nodo n = new Nodo();
        Nodo apuntador1 = p2.obtenerCabeza();
        Nodo apuntador2 = r.obtenerCabeza();
        Polinomio validador = new Polinomio();
        Nodo apuntador3 = validador.obtenerCabeza();

        
        while(apuntador1 != null){
           
            n.coeficiente = apuntador2.coeficiente * apuntador1.coeficiente;
            //debo sumar con el residuo
            n.coeficiente = n.coeficiente + apuntador3.coeficiente;
            validador.agregar(n);
        ...
        JOptionPane.showMessageDialog(null, "Validacion Errada");
